...
import SocialMedia.LDLinkedList.LDLinkedList;
...
public class Post {
    ...
    public void unlikePost(Account accountId)
    {
        ...
        if(likes.contains(accountId))
        {
            likes.remove(accountId);
        }
        else
    ...
    public void deleteComment(Comment commentId)
    {
        ...
        if(comments.contains(commentId))
            comments.remove(comments.indexOf(commentId));
        else
    ...
    public Post(int postId, Account accountId, String content) {
        ...
        likes = new LDLinkedList<>();
        comments = new LDLinkedList<>();
    }
